package com.upc.courtly.iam.application.internal.commandservices;

import com.upc.courtly.iam.application.internal.outboundservices.hashing.HashingService;
import com.upc.courtly.iam.application.internal.outboundservices.tokens.TokenService;
...
public class UserCommandServiceImpl implements UserCommandService {
    ...
    public Optional<User> handle(SignUpCommand command) {
        ...
        var roles = (command.roles() == null || command.roles().isEmpty())
            ? List.of(roleRepository.findByName(com.upc.courtly.iam.domain.model.valueobjects.Roles.ROLE_USER).orElseThrow(() -> new RuntimeException("Role name not found")))
